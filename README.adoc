...
| 1    | link:src/main/java/iut/sae/algo/Algo.java[meilleur java]| Java     | Efficacité
| 2    | link:src/main/java/iut/sae/algo/Simplicite.java[meilleur Python]    | Python     | Simplicité  
|==========================================================================
